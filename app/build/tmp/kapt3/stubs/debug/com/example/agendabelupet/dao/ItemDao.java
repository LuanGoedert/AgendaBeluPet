...
public abstract interface ItemDao {
    ...
    @org.jetbrains.annotations.Nullable()
    @androidx.room.Query(value = "UPDATE ItemEntity SET dataQuinzenal = :newDate WHERE Id = :id")
    public abstract java.lang.Object updateDateBiWeekly(@org.jetbrains.annotations.NotNull()
