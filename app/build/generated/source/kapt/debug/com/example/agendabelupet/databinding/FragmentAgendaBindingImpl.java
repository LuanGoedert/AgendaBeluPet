...
public class FragmentAgendaBindingImpl extends FragmentAgendaBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.button_see_profit, 3);
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewModel == variableId) {
            setViewModel((com.example.agendabelupet.ui.agenda.AgendaViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel(@Nullable com.example.agendabelupet.ui.agenda.AgendaViewModel ViewModel) {
